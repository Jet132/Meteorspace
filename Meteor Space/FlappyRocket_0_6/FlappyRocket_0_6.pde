...
void setup() {
  ...
  Button_start[2]= height/2.2105263157894737;
  Button_start[3]= height/6.5625;
  Button_beenden[0]= width/2;
  Button_beenden[1]= height/2+height/6.5625;
  Button_beenden[2]= height/1.010587103-height/1.62037037;
  Button_beenden[3]= height/1.424694708-height/1.674641148;
  Button_neustart[0]= width/2;
  Button_neustart[1]= height/2+height/3.75;
  Button_neustart[2]= height/3.28125;
  Button_neustart[3]= height/11.6666666666666667;
  imageMode(CENTER);
  rectMode(CENTER);
}
...
void draw() {
  ...
  if (start == 0) {
    ...
    fill(#FFFFFF);
    stroke(#CBCBCB);
    rect(width/2, height/2+height/11.6666666666666667, height/1.68698517298, height/2.02371541502, 100);
    fill(#0FF25C);
    stroke(#00B93C);
    ...
    image(Titel, width/2, height/6.8266666666666667, height/1.28, height/2.56);

    fill(#000000);
    textSize(height/10.24);
    text("Start", (width/2) - width/11.2, height/1.8618181818181818);
    textSize(height/17.0666666667);
    text("Beenden", (width/2) - width/11.7482517482517483, height/1.48405797101);
    textSize(height/20.48);
    text("Neustart", width/2 - width/14.608695652173913, height/2+height/3.50);
  ...
  if (start == 1) {
    ...
    stroke(#ff0000);
    fill(#ff0000);
    rect(width/2-330, height/2+height/2.625-45, ((667.5 / punkte_max) * Punkte), 45);

    if (Leben <= 3) {
      if (Leben == 1) {
        rect(width/2-285, height/2+height/2.625+17+10, 189.75, 45);
      }
      if (Leben == 2) {
        rect(width/2-285, height/2+height/2.625+17+10, 390, 45);
      }
      if (Leben == 3) {
        rect(width/2-285, height/2+height/2.625+17+10, 570, 45);
      }
    } else {
      rect(width/2-285, height/2+height/2.625+17+10, 570, 45);
    }
    ...
    fill(#ffaa08);
    if (Leben <= 3) {
      rect(width/2-105, height/2+height/2.625+17+10, 10, 45);
      rect(width/2+105, height/2+height/2.625+17+10, 10, 45);
    } else {
      rect(width/2, height/2+height/2.625+17+10, 10, 45);
      rect(width/2-142.5, height/2+height/2.625+17+10, 10, 45);
      rect(width/2+142.5, height/2+height/2.625+17+10, 10, 45);
    }
    image(LvL, width/2, height/2+height/2.625+10, 750, 150);
    ...
    fill(#ffffff);
    text("Level" + level, width/2-60, height/2+height/2.625-10);
